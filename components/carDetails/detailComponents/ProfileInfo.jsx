    ...
    <>
      ...
      <div className="mt-3 ">
        <div className="inner listing-infor-box ">
          ...
          <div className="content-listing-info">
            <span className="listing-info-title">Disclaimer</span>
            <p className="listing-info-value">{car?.disclaimer || "Not found"}</p>
          </div>
        </div>
      </div>
      {/* <div className="">
      ...
      <div className="">
        <div className="inner listing-infor-box">
          ...
          <div className="content-listing-info">
            <span className="listing-info-title">Comparison</span>
            <p className="listing-info-value">{car?.comparison_rate  || "Not found"}</p>
          </div>
        </div>
      </div>
