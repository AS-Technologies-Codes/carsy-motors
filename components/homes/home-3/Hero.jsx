...
export default function Hero() {
  ...
  return (
    <section>
      <div className="container mt-10 mt-md-5 mb-md-3 mt-md-6 center text-md-start">
        <h2> View Our Fleet</h2>
        <p>
          Our experienced team excels in car sales with many years of
          successfully navigating the market, delivering informed decisions and
          optimal results.
        </p>{" "}
      </div>
      {FleetLoading ? (
        ...
        >
          {FleetListing.map((slide, index) => (
            <SwiperSlide className="swiper-slide" key={index}>
              <div className="mt-3">
                ...
                <section className="tf-section3 section-why-choose-us d-block d-md-none">
                  <div className="container">
                    <div className="row">
                      <div className="col-md-6">
                        <div className="content-wcs">
                          <div className="heading-section center mb-3">
                            <h2
                              className="wow fadeInUpSmall fs-1"
                              data-wow-delay="0.2s"
                              data-wow-duration="1000ms"
                            >
                              {slide.name}
          ...
          <div
            className="swiper-button-next style7-next snbn21 bg-primary"
            style={{ top: "85%" }}
          />
          <div
            className="swiper-button-prev style7-prev snbp21 bg-primary"
            style={{ top: "85%" }}
          />
        </Swiper>
      )}
