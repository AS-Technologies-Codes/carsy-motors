...
import Booking from "@/components/otherPages/Booking";
import React from "react";
import Link from "next/link";
import { Metadata } from "@/utils/metadata";

export const metadata = Metadata("Booking");
  ...
  return (
    <>
      ...
      <div className="slider home2 position-relative">
        ...
        <div
          className="content po-content-two position-absolute top-50 w-100"
          style={{ zIndex: 999 }}
        >
          <div className="heading">
            <h1 className="text-color-1 text-center">Car Booking</h1>
          </div>
        </div>
      </div>
