...
export default function Hero() {
  ...
  const fecthGetCars = async () => {
    ...
    const getGetCarsRequest = await fetch(`${URL.getCars}&limit=6`, {
      method: "GET",
      headers: {
  ...
  return (
    ...
    >
      ...
      )}
      {
        ...
        (CarsLoading ? [slider3[0]] : CarsData).map((elm, i) => (
                      ...
                      <div className="heading">
                        ...
                        <ul className="ul flex category-list-car flex-wrap fade-item fade-item-2">
                          ...
                          <li className="flex-three">
                            ...
                            <div className="font text-color-1">{elm.km}</div>
                          </li>
                          <li className="flex-three">
                            <div className="icon">
                              <svg
                            ...
                            <div className="font text-color-1">{elm.price}</div>
                          </li>
                        </ul>
                      </div>
                    </div>
